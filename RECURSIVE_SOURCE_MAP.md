...
- General `Proj` infrastructure for the scheme-theoretic projective line.  This
  ...
  conversion from that family to marked cover/noncritical data and the resulting
  finite-subcover wrapper.  Still missing is the curve theorem producing these
...
- The vector-space lemma that a finite union of proper subspaces does not cover
  ...
  Belyi maps and instantiates `FiniteMarkedBelyiExistence`.  The more specialized
