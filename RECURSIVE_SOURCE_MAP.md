...
- General `Proj` infrastructure for the scheme-theoretic projective line.  This
  ...
  finite marked-point triple of cardinality three and checks their
  ...
  pointwise-cover/finite-subcover wrappers.  Still missing is the
