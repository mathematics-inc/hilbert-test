...
- General `Proj` infrastructure for the scheme-theoretic projective line.  This
  ...
  ideals `(X0)` and `(X1)`, and relevance witnesses in
  `HilbertTest.SourceStack.SchemeProjectiveLine`; still missing is coordinate
  ideal primeness and marked-point identification.
