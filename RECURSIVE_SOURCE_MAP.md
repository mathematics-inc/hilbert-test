...
- The vector-space lemma that a finite union of proper subspaces does not cover
  ...
  `P1` once composite étaleness over the marked branch-open is supplied, checks
  the composition-through-`P1` set control, and turns a family of reduction
  steps into `FiniteMarkedBelyiExistence`.  The inclusion-exclusion estimates remain
  separate.
