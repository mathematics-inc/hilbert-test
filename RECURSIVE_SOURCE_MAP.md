...
| Rational maps/function fields | Mathlib `AlgebraicGeometry.RationalMap`; Stacks Project rational maps | Checked dense-domain and partial-map representative wrappers in `SourceStack.RationalMaps`; still needs curve-specific divisors/Riemann-Roch |
