...
- General `Proj` infrastructure for the scheme-theoretic projective line.  This
  ...
  `[0:1]`, `[1:0]`, and `[1:1]` in
  `HilbertTest.SourceStack.SchemeProjectiveLine`; still missing is marked-point
  identification with the linear projective-line layer.
