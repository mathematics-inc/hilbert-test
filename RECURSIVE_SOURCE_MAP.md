...
- General `Proj` infrastructure for the scheme-theoretic projective line.  This
  ...
  morphism-family cover/noncritical interfaces.  Still missing is the curve
  theorem producing morphisms/rational functions with these marked points as
  branch targets.
