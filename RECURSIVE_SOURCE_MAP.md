...
- General `Proj` infrastructure for the scheme-theoretic projective line.  This
  ...
  checked in `HilbertTest.SourceStack.MarkedProjectiveLine`.  Still missing is
  the morphism/rational-function API using these marked points as branch
  targets.
