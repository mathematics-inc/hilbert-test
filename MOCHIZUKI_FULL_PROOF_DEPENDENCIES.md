...
- `HilbertTest.SourceStack.SchemeBelyi`: scheme-level abstract Definition 1.1
  ...
  source Belyi open with avoidance of the checked marked triple, including
  T1-specialized forms that require no explicit branch-open hypothesis.  The finite
